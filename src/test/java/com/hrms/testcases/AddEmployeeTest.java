...
public class AddEmployeeTest extends CommonMethods {
	...
	public void addEmployee(String firstName, String lastName, String username, String password) {
		...
		//test.info("Adding employee first name and last name");
		sendText(addEmp.firstName, firstName);
		sendText(addEmp.lastName, lastName);
		// get EmployeeID
		
		String expectedEmpId = addEmp.employeeId.getAttribute("value");
		//test.info("Clicking on Create Login Details");
		// click on Create Login Details
		click(addEmp.checkboxLoginDetails);
		wait(1);
		//test.info("Adding username, password and confirming password");
		...
		// validation
		//test.info("Verifying new employee was added");
